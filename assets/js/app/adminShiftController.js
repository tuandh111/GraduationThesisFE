app.controller('AdminShiftController', function ($scope, $http, $rootScope, $location, $timeout,API) {
    ...
    $scope.getListTimeOfShift = () => {
        $http.get(url + '/time-of-shift-except-deleted').then(respone => {
    ...
    $scope.crudShift = () => {
        ...
        $scope.deleteShift = (shift, $event) => {
            ...
            var timeOfShiftId = $scope.getTimmeOfShiftFilerByShiftId(shift)[0].timeOfShiftId
            Swal.fire({
