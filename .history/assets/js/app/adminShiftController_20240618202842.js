    ...
    $scope.crudShift = () => {
        ...
        $scope.editShift = (shift, $event) => {
            ...
            if (shift != null) {
                ...
                $scope.formTimeOfShift.beginTime=$scope.listTimmeOfShiftFilerByShiftId.beginTime
              //  $scope.formTimeOfShift.endTime=$scope.listTimmeOfShiftFilerByShiftId.endTime
                console.log("$scope.listTimmeOfShiftFilerByShiftId.beginTime",$scope.listTimmeOfShiftFilerByShiftId[0].beginTime);
