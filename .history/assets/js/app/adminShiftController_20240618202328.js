    ...
    $scope.crudShift = () => {
        ...
        $scope.editShift = (shift, $event) => {
            ...
            if (shift != null) {
                ...
                $scope.formTimeOfShift.beginTime=moment($scope.listTimmeOfShiftFilerByShiftId.beginTime, "HH:mm:ss").format("HH:mm")
                $scope.formTimeOfShift.endTime=moment($scope.listTimmeOfShiftFilerByShiftId.endTime, "HH:mm:ss").format("HH:mm")
