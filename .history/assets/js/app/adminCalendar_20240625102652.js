...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout,dataProcessorService) {
    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#formAppointmentRequestAppointmentType').on('change', function () {
            $timeout(function () {
                ...
                $scope.formAppointmentRequest.appointmentType=dataProcessorService.processSelect2Data(selectedVal)
            });
        });
    }
