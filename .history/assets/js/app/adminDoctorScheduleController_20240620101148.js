    ...
    $scope.crudDoctor = () => {
        ...
        $scope.validationForm = () => {
            ...
            $scope.processSelect2Data = () => {
                if(selecteShiftdValues.length==1){
                    if (typeof selecteShiftdValues === 'object' && selecteShiftdValues.includes(':')) {
                        // selecteShiftdValues = parseInt(selecteShiftdValues.split(':')[1]);
                        alert(selecteShiftdValues)
                    }
                }                
            }
