app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout,$window,processSelect2Service) {
    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#formDoctorScheduleShiftId').on('change', function () {
            $timeout(function () {
                ...
                selecteShiftdValues=processSelect2Service.processSelect2Data(selectedVal)
            });
        });
