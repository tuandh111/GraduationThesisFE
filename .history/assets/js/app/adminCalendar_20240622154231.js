...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.convertDateToISO = (date) => {
        // Chuyển đổi ngày từ định dạng DD/MM/YYYY sang đối tượng moment
        var momentDate = moment(date, 'DD/MM/YYYY');
        
        // Chuyển đổi đối tượng moment sang định dạng ISO với múi giờ UTC
        var isoDate = momentDate.utc().format('YYYY-MM-DDTHH:mm:ss.SSSZ');
        
        console.log("isoDate", isoDate);  // Output: 2024-06-26T17:00:00.000+00:00
        return isoDate;
    };
