app.controller('AdminShiftController', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.crudShift = () => {
        ...
        $scope.caculatorTimeDif = (beginTime, endTime) => {
            beginTime = new Date();
            endTime = new Date();

            // Set hours and minutes for beginTime
            ...
            // Set hours and minutes for endTime
            ...
            console.log('Duration of shift (hours):', hoursDiff);
        }
        ...
        $scope.createShift = () => {
            ...
            $scope.formTimeOfShift.beginTime = beginTimeValue
            $scope.formTimeOfShift.endTime = endTimeValue
            console.log(typeof endTimeValue);
