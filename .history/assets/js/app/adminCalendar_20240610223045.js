...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.saveEvent = function() {
        ...
        var eventPantient = $scope.eventPantient;
        var eventService = $scope.eventService;
        var eventDoctor = $scope.eventDoctor;
        var eventStartDate = $scope.eventStartDate;
        var eventStartTime = $scope.eventStartTime;
        var eventEndDate = $scope.eventEndDate;
        var eventEndTime = $scope.eventEndTime;
        var allDay = $scope.allDay;

        // Tạo thông điệp alert chứa thông tin đã nhập
        var message = "Tiêu đề cuộc hẹn: " + eventTitle + "\n" +
                      "Bệnh nhân: " + eventPantient + "\n" +
                      "Dịch vụ: " + eventService + "\n" +
                      "Bác sĩ: " + eventDoctor + "\n" +
                      "Ngày bắt đầu: " + eventStartDate + " " + eventStartTime + "\n" +
                      "Ngày kết thúc: " + eventEndDate + " " + eventEndTime + "\n" +
                      "All day: " + allDay;
