...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService) {
    ...
    var listDoctorUnavailabilityAllDoctor=""
    $scope.setupTab = () => {
    ...
    $scope.initializeFullCalendar = () => {
        ...
        var events=listDoctorUnavailabilityAllDoctor
        // var events = [
        //     {
        //         title: "Kiểm tra răng",
    ...
    $scope.getListDoctorUnavailabilityAllDoctor= () => {
        ...
        $scope.processDoctorUnavailabilityAllDoctor().then(result => {
            listDoctorUnavailabilityAllDoctor = result;  
            console.log("listDoctorUnavailabilityAllDoctor",listDoctorUnavailabilityAllDoctor);        
        }).catch(error => {
