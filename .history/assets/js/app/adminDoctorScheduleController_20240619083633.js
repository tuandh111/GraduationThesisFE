app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location,$timeout) {
    ...
    //     }
    // ];
    $scope.formDoctorSchedule.shiftId=[]
    $scope.getListShift = () => {
    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#formDoctorScheduleShiftId').on('change', function () {
            $timeout(function () {
                var selectedValues = $('#formDoctorScheduleShiftId').val()
                alert(selectedValues)
               $scope.formDoctorSchedule.shiftId = selectedValues;
            });
        });
    }
    ...
    $scope.getTimeShift = () => {
        ...
        var selectedShiftId = $scope.formDoctorSchedule.shiftId;
