                ...
                var calendar = new FullCalendar.Calendar(calendarEl,
                    {
                        ...
                        eventClick: function (info) {
                            ...
                            var eventDetails =
                                ...
                                '<strong>Thời gian bắt đầu:</strong> ' + TimezoneService.convertToTimezone(info.event.start, defaultTimezone) + '<br>' +
                                '<strong>Thời gian kết thúc:</strong> ' +TimezoneService.convertToTimezone(info.event.end, defaultTimezone);
