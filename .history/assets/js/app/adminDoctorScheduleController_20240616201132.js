        ...
        $('.drgpicker').daterangepicker(
            {
                ...
                startDate: moment().add(1, 'days').hour(8).minute(0), // Ngày giờ bắt đầu mặc định, ví dụ từ 8:00 sáng ngày mai
                endDate: moment().add(1, 'days').hour(17).minute(0), // Ngày giờ kết thúc mặc định, ví dụ đến 17:00 ngày mai
                minDate: moment().add(1, 'days'), // Ngày giờ bắt đầu từ ngày mai
