    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#beginTimeOfShift').on('change', function () {
            ...
            if (beginTime) {
                ...
                // Tạo danh sách các giờ kết thúc có thể chọn từ beginTime trở đi, tối đa là 21:00
                for (var i = 0; i <= 21; i++) { // chỉ duyệt từ 0 đến 20 giờ
                ...
                // Cập nhật dropdown hoặc danh sách giờ kết thúc
                ...
                // Chọn giá trị đầu tiên trong dropdown (nếu có)
