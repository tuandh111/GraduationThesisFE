                ...
                var calendar = new FullCalendar.Calendar(calendarEl,
                    {
                        ...
                        eventClick: function (info) {
                            ...
                            var eventDetails =
                                ...
                                '<strong>Thời gian bắt đầu:</strong> ' + moment(info.event.start).format('DD/MM/YYYY HH:mm:ss') + '<br>' +
                                '<strong>Thời gian kết thúc:</strong> ' +moment(info.event.end).format('DD/MM/YYYY HH:mm:ss');
