...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.saveAppoinment = () => {
        ...
        var mess = "patientId: "+patientId +" appointmentType "+appointmentType+" appointmentDate: "+appointmentDate+" note "+note+" doctorId: "+doctorId
    ...
    $scope.initializeUIComponents = () => {
        ...
        $scope.captureTimeOfShiftId = function(timeOfShiftId) {
            $scope.formDoctorUnavailabilityRequest.timeOfShiftId = timeOfShiftId;
            console.log("Selected Time Of Shift ID: ", timeOfShiftId);
        };
    }
