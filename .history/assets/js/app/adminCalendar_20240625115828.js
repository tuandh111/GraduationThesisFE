        ...
        $scope.saveAppoinment = () => {
            ...
            if (valid) {
                ...
                $http.post(url, '/appointment', appointmentRequestJSON).then(response => {
                    ...
                    $scope.formDoctorUnavailabilityRequest.date = response.data.appointmentDate
                    ...
                    $scope.formAppointmentPatientRecordRequest.patientId = response.data.patientId
                    $scope.formAppointmentPatientRecordRequest.createAt = response.data.createAt
                    var appointmentRecordRequestJSON = angular.fromJson($scope.formAppointmentPatientRecordRequest)
                    $http.post(url, '/appointmentRecord', appointmentRecordRequestJSON).then(resp => {
