    ...
    $scope.saveAppointment = async () => {
        ...
        if (valid) {
            try {
                ...
                $scope.formDoctorUnavailabilityRequest.doctorId = $scope.getDataAfterPostAppointmentSuccess.appointment == null ? null : $scope.getDataAfterPostAppointmentSuccess.appointment.appointmentId
