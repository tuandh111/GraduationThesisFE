    ...
    $scope.saveAppointment = async () => {
        ...
        if (valid) {
            try {
                ...
                // $scope.formDoctorUnavailabilityRequest.appointmentId = $scope.getDataAfterPostAppointmentSuccess.appointmentId == null ? null : $scope.getDataAfterPostAppointmentSuccess.appointmentId
