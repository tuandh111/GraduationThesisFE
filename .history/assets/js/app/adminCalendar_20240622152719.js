...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.getListDoctorSchedule = (date) => {
        date=moment(date, 'DD/MM/YYYY').format('YYYY-MM-DDTHH:mm:ss.SSSZ')
       // console.log("date", date);  
        var requestDateJSON = { date: date };
        console.log("requsetDateJSON",requestDateJSON);
        // $http.get(url+"/doctor-schedule-by-date",{"date":requsetDateJSON}).then(response => {
