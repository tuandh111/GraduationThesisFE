app.controller('AdminShiftController', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.crudShift = () => {
        ...
        $scope.$watch('formTimeOfShift.beginTime', function(newVal, oldVal) {
            $scope.formTimeOfShift.beginTime =newVal
            console.log('formTimeOfShift updated:', $scope.formTimeOfShift);
        });
        ...
        $scope.createShift = () => {
            var requsetDoctorJSON = angular.toJson($scope.formTimeOfShift)
            console.log("formTimeOfShift.beginTime", requsetDoctorJSON)
