            ...
            var calendar = new FullCalendar.Calendar(calendarEl,
                {
                    ...
                    eventClick: function (info) {
                        ...
                        // Hiển thị offcanvas sử dụng Bootstrap 4
                        $('#offcanvasTop').addClass('show'); // Hiển thị offcanvas
                        $('body').addClass('offcanvas-open'); // Thêm lớp để mở offcanvas

                        // Đóng offcanvas khi nhấp vào nút đóng
                        $('[data-dismiss="offcanvas"]').on('click', function () {
                            $('#offcanvasTop').removeClass('show'); // Ẩn offcanvas
                            $('body').removeClass('offcanvas-open'); // Loại bỏ lớp mở offcanvas
                        });
                    }
                });
            calendar.render();
