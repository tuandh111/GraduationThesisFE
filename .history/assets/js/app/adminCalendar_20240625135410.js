...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service) {
    ...
    $scope.initializeUIComponents = () => {
        ...
        $scope.isVisible = (beginTime) => {
            var appointmentDate = new Date($scope.formAppointmentRequest.appointmentDate);
            var today = new Date();
            today.setHours(0, 0, 0, 0);
            console.log("$scope.formAppointmentRequest.appointmentDate",$scope.formAppointmentRequest.appointmentDate);
            console.log("appointmentDate",appointmentDate);
            console.log("today",today);
            // console.log("appointmentDate.getTime() === today.getTime()",appointmentDate.getTime() === today.getTime());
            return appointmentDate.getTime() === today.getTime() && $scope.getCurrentTime() <= beginTime
        };
