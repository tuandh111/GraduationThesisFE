...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.setupTab = () => {
        // $scope.currentTab = -1;
        // $scope.selectTab = (shiftId, $event) => {
        //     $event.preventDefault()
        //     $scope.currentTab = shiftId;
        ...
        //         console.error('Có lỗi khi lấy dữ liệu theo ' + shiftId + ':', error);
        //     });

        // }
        // $scope.isSelected = (shiftId) => {
        //     return $scope.currentTab === shiftId;
        // }
    ...
    $scope.saveAppoinment = () => {
        ...
        var mess = "patientId: "+patientId +" appointmentType "+appointmentType+" appointmentDate: "+appointmentDate+" note "+note
    ...
    $scope.initializeUIComponents = () => {
        ...
        //     });
        // });
        $scope.formAppointmentRequest.appointmentDate=moment($('#appointmentDateRequest').val(),"DD/MM/YYYY").format('YYYY-MM-DD')
    }
    ...
    $scope.initData = () =>{
        ...
        //$scope.DoctorUnavailabilityRequest.date=$scope.formAppointmentRequest.appointmentDate
