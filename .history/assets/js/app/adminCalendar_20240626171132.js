                ...
                var calendar = new FullCalendar.Calendar(calendarEl,
                    {
                        ...
                        eventClick: function (info) {
                            ...
                            var localStart = moment.utc(info.event.start).local();
                            var localEnd = moment.utc(info.event.end).local();
                            var formattedStartTime = localStart.format('YYYY-MM-DD HH:mm:ss');
                            var formattedEndTime = localEnd.format('YYYY-MM-DD HH:mm:ss');
