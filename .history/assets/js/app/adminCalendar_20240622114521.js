    ...
    $scope.initializeUIComponents = () => {
        ...
        $('.drgpicker').daterangepicker(
            ...
            function (start, end, label) {
                ...
                var customCollapseDiv = $('.form-row.custom-collpanse');
                if (customCollapseDiv.is(':visible')) {
                    customCollapseDiv.hide(); // Ẩn div nếu nó đang hiển thị
                } else {
                    customCollapseDiv.show(); // Hiển thị div nếu nó đang bị ẩn
                }
            }
        );
