app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.crudDoctor = () => {
        ...
        $scope.validationForm = () => {
            var valid = true
            console.log("$scope.listDoctorScheduleDB from valiform",$scope.listDoctorScheduleDB);
        ...
        $scope.createDoctorSchedule = () => {
            ...
            if (validForm) {
                ...
                // $scope.htmlContent = '<p>Thời gian đăng ký là : ' + dates + '</p>' +
                //     '<p>Ca đăng ký: ' + shiftIds + '</p>';
                // Swal.fire({
                //     title: "Thành công",
