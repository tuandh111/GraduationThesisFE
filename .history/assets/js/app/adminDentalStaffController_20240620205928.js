app.controller('AdminDentalStaffController', function ($scope, $http, $rootScope, $location, $timeout) {
    ...
    $scope.getListdentalStaff = () => {
        $http.get(url + '/dentalStaff').then(respone => {
    ...
    $scope.cruddentalStaff = () => {
        ...
        $scope.editdentalStaff = (dentalStaff, $event) => {
            ...
            if (dentalStaff != null) {
                $scope.formDentalStaff = {
                    image: dentalStaff.image,
                    dentalStaffId: dentalStaff.dentalStaffId,
                    fullName: dentalStaff.fullName,
                    degrees: dentalStaff.degrees,
                    //specialtyId: dentalStaff.specialty,
                    ...
                    signature: dentalStaff.signature,
                    deleted: dentalStaff.deleted
                }
                $scope.formDentalStaff.specialtyId = dentalStaff.specialty ? dentalStaff.specialty.specialtyId : -1
        ...
        $scope.createdentalStaff = () => {
            ...
            if (valid) {
                ...
                $http.post(url + '/dentalStaff', requsetdentalStaffJSON).then(respone => {
                    Swal.fire({
                        title: "Thành công!",
        ...
        $scope.updatedentalStaff = () => {
            ...
            if (valid) {
                ...
                console.log("requsetdentalStaffJSON", requsetdentalStaffJSON);
                $http.put(url + '/dentalStaff/' + dentalStaffId, requsetdentalStaffJSON).then(respone => {
                    Swal.fire({
                        title: "Thành công!",
        ...
        $scope.deletedentalStaff = (dentalStaff, $event) => {
            ...
            Swal.fire({
                ...
                if (rs.isConfirmed) {
                    $http.delete(url + '/sort-delete-dentalStaff/' + dentalStaffId).then(respone => {
                        Swal.fire({
                            title: "Thành công!",
