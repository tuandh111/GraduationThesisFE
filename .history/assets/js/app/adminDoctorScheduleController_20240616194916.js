        ...
        $('.drgpicker').daterangepicker(
            {
                ...
                // timePicker: false,
                timePicker: true, // Bật chọn thời gian
                timePickerIncrement: 30, // Đơn vị tăng giảm thời gian là 30 phút
                showDropdowns: true,
                ...
                ranges: {
                    'Sáng': ['07:00', '11:59'], // Khoảng thời gian sáng từ 7:00 - 11:59
                    'Trưa': ['12:00', '14:59'], // Khoảng thời gian trưa từ 12:00 - 14:59
                    'Chiều': ['15:00', '17:59'], // Khoảng thời gian chiều từ 15:00 - 17:59
                    'Tối': ['18:00', '23:59'] // Khoảng thời gian tối từ 18:00 - 23:59
                },
                startDate: moment().startOf('hour'), // Ngày giờ bắt đầu mặc định
                endDate: moment().startOf('hour').add(1, 'hour') // Ngày giờ kết thúc mặc định (ví dụ 1 giờ sau ngày hiện tại)
            },
            function (start) {
