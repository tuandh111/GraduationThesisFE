        ...
        $('.drgpicker').daterangepicker(
            {
                ...
                locale:
                {
                    ...
                    applyLabel: 'Áp dụng',
                    cancelLabel: 'Hủy',
                    daysOfWeek: ['CN', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7'], // Tên ngày trong tuần
                    monthNames: ['Tháng 1', 'Tháng 2', 'Tháng 3', 'Tháng 4', 'Tháng 5', 'Tháng 6', 'Tháng 7', 'Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11', 'Tháng 12'], // Tên tháng
                    firstDay: 1
                },           
                startDate: moment().add(1, 'days'), // Ngày bắt đầu mặc định là ngày mai
                endDate: moment().add(8, 'days'), // Ngày kết thúc mặc định là 8 ngày sau
                opens: 'center', // Mở lịch ở giữa màn hình
                drops: 'down', // Hiển thị lịch từ trên xuống dưới
