        ...
        $scope.processDoctorUnavailabilityAllDoctor().then(result => {
            events = result.map(item => {
                return {
                    ...
                    start: TimezoneService.convertToTimezone(item.timeOfShift.beginTime,defaultTimezone),
                    end: TimezoneService.convertToTimezone(item.timeOfShift.endTime,defaultTimezone),
                ...
                var calendar = new FullCalendar.Calendar(calendarEl,
                    {
                        ...
                        eventClick: function (info) {
                            ...
                            var eventDetails =
                                ...
                                '<strong>Thời gian bắt đầu:</strong> ' + info.event.start + '<br>' +
                                '<strong>Thời gian kết thúc:</strong> ' + info.event.end;
