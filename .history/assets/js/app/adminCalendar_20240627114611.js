    ...
    $scope.saveAppointment = async () => {
        ...
        if (valid) {
            try {
                ...
                $scope.formDoctorUnavailabilityRequest.appointmentId = $scope.getDataAfterPostAppointmentSuccess.appointment == null ? null : $scope.getDataAfterPostAppointmentSuccess.appointment.appointmentId
