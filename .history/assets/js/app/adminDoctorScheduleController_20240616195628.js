        ...
        $('.drgpicker').daterangepicker(
            {
                ...
                // minDate: moment().add(1, 'hour').startOf('hour'), // Giới hạn thời gian tối thiểu từ giờ hiện tại cộng 1
                // maxDate: moment().startOf('day').add(21, 'hours'), // Giới hạn thời gian tối đa là 21 giờ trong ngày
