                ...
                var calendar = new FullCalendar.Calendar(calendarEl,
                    {
                        ...
                        eventClick: function (info) {
                            ...
                            // var startMoment = moment.utc(info.event.start).tz('Asia/Ho_Chi_Minh');
                            // var endMoment = moment.utc(info.event.end).tz('Asia/Ho_Chi_Minh');
                            // var formattedStartTime = startMoment.format('YYYY-MM-DD HH:mm:ss');
                            // var formattedEndTime = endMoment.format('YYYY-MM-DD HH:mm:ss');

                            // var eventDetails =
                            //     '<strong>Tên bác sĩ:</strong> ' + info.event.extendedProps.doctor + '<br>' +
                            //     '<strong>Bệnh nhân:</strong> ' + info.event.title + '<br>' +
                            //     '<strong>Thời gian bắt đầu:</strong> ' + formattedStartTime + '<br>' +
                            //     '<strong>Thời gian kết thúc:</strong> ' + formattedEndTime;
